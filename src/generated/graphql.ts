  ...
  characters?: Maybe<
    { __typename?: 'Characters' } & {
      results?: Maybe<
        Array<
          Maybe<
            { __typename?: 'Character' } & Pick<Character, 'id' | 'name' | 'status' | 'gender' | 'image' | 'species'> & {
                origin?: Maybe<{ __typename?: 'Location' } & Pick<Location, 'name'>>;
                episode?: Maybe<Array<Maybe<{ __typename?: 'Episode' } & Pick<Episode, 'name'>>>>;
              }
          >
        >
      >;
...
export const GetAllCharactersDocument = `
  ...
  characters(page: $page) {
    ...
    `;
export const useGetAllCharactersQuery = <TData = GetAllCharactersQuery, TError = unknown>(
